...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([Card(Suit.SHIELD, 7)], [Suit.SHIELD]),
        ([], []),
    ],
)
...
@pytest.mark.parametrize(
    "round_color, cards, have_to_serve",
    [
        (Suit.ROSE, [Suit.BELL, Suit.ACORN, Suit.SHIELD, Suit.ROSE], True),
        (Suit.ROSE, [Suit.BELL, Suit.ACORN], False),
        (Suit.SHIELD, [Suit.BELL], False),
        (Suit.BELL, [Suit.BELL, Suit.ACORN, Suit.SHIELD, Suit.ROSE], True),
        (Suit.ACORN, [Suit.BELL, Suit.SHIELD, Suit.ROSE], False),
        (None, [Suit.BELL, Suit.ACORN, Suit.SHIELD, Suit.ROSE], False),
    ],
)
