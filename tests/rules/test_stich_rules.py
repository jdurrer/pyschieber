...
from pyschieber.rules.stich_rules import (
    allowed_cards,
    card_allowed,
    does_under_trumpf,
...
def played_cards(players):
    return [
        PlayedCard(player=players[0], card=Card(Suit.ACORN, 6)),
...
@pytest.mark.parametrize(
    "table_cards, chosen_card, hand_cards, trumpf, result",
    [
        (
            [Card(Suit.ACORN, 12)],
            Card(Suit.BELL, 12),
            [Card(Suit.ACORN, 11), Card(Suit.BELL, 12), Card(Suit.BELL, 11)],
            Trumpf.OBE_ABE,
            False,
        ),
        (
            [Card(Suit.BELL, 12)],
            Card(Suit.BELL, 12),
            [Card(Suit.BELL, 12), Card(Suit.BELL, 11)],
            Trumpf.BELL,
            True,
        ),
        (
        ...
        (
            [Card(Suit.ACORN, 11)],
            Card(Suit.BELL, 12),
            [Card(Suit.ACORN, 12), Card(Suit.BELL, 11), Card(Suit.BELL, 12)],
            Trumpf.ACORN,
            False,
        ),
        (
            [Card(Suit.ACORN, 11)],
            Card(Suit.ACORN, 11),
            [Card(Suit.BELL, 12), Card(Suit.ACORN, 11), Card(Suit.ACORN, 12)],
            Trumpf.UNDE_UFE,
            True,
        ),
        (
            [Card(Suit.ACORN, 11)],
            Card(Suit.ACORN, 11),
            [Card(Suit.BELL, 12), Card(Suit.ACORN, 12)],
            Trumpf.UNDE_UFE,
            False,
        ),
        (
            [Card(Suit.ROSE, 6)],
            Card(Suit.ACORN, 11),
            [Card(Suit.ROSE, 10), Card(Suit.ACORN, 11)],
            Trumpf.ROSE,
            False,
        ),
        (
            [Card(Suit.ROSE, 6)],
            Card(Suit.ACORN, 11),
            [Card(Suit.ROSE, 11), Card(Suit.ACORN, 11)],
            Trumpf.ROSE,
            True,
        ),
        (
            [Card(Suit.ROSE, 7)],
            Card(Suit.ROSE, 6),
            [Card(Suit.ROSE, 6), Card(Suit.ACORN, 11)],
            Trumpf.ROSE,
            True,
        ),
        (
            [Card(Suit.ACORN, 6), Card(Suit.ROSE, 7)],
            Card(Suit.ROSE, 6),
            [Card(Suit.ROSE, 6), Card(Suit.ACORN, 11)],
            Trumpf.ROSE,
            False,
        ...
        (
            [Card(Suit.ROSE, 12), Card(Suit.SHIELD, 11)],
            Card(Suit.ROSE, 8),
            [
                Card(Suit.ROSE, 6),
                Card(Suit.ROSE, 8),
        ...
        (
            [Card(Suit.SHIELD, 6), Card(Suit.ROSE, 6), Card(Suit.ROSE, 9)],
            Card(Suit.ROSE, 10),
            [Card(Suit.ROSE, 10), Card(Suit.BELL, 11)],
            Trumpf.ROSE,
            False,
        ),
        (
            [Card(Suit.SHIELD, 13), Card(Suit.ACORN, 6), Card(Suit.SHIELD, 10)],
            Card(Suit.ROSE, 8),
            [
                Card(Suit.SHIELD, 8),
                Card(Suit.SHIELD, 9),
...
@pytest.mark.parametrize(
    "hand_cards, table_cards, trumpf, result",
    [
        (
            [Card(Suit.BELL, 12)],
            [Card(Suit.BELL, 11)],
        ...
        (
            [Card(Suit.BELL, 12), Card(Suit.ROSE, 12)],
            [Card(Suit.BELL, 11)],
            Trumpf.ACORN,
            [Card(Suit.BELL, 12)],
        ),
...
def test_allowed_cards(hand_cards, table_cards, trumpf, result):
    assert (
        allowed_cards(hand_cards=hand_cards, table_cards=table_cards, trumpf=trumpf)
        == result
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [Card(Suit.ACORN, 12)],
            Card(Suit.ACORN, 6),
            [Card(Suit.ACORN, 6), Card(Suit.BELL, 6)],
            Trumpf.ACORN,
            True,
        ),
        (
        ...
        (
            [Card(Suit.BELL, 12)],
            Card(Suit.BELL, 6),
            [Card(Suit.BELL, 6), Card(Suit.ROSE, 6)],
            Trumpf.BELL,
            True,
        ),
        (
            [Card(Suit.BELL, 12)],
            Card(Suit.BELL, 6),
            [Card(Suit.BELL, 6), Card(Suit.BELL, 7)],
            Trumpf.BELL,
            False,
        ),
    ],
