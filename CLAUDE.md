...
This repo tracks work in GitHub Issues. See `docs/agents/issue-tracker.md`.

### Triage labels

This repo uses the canonical triage labels with the default names. See `docs/agents/triage-labels.md`.

### Domain docs

This repo uses the single-context layout with one root `CONTEXT.md` and `docs/adr/`. See `docs/agents/domain.md`.
