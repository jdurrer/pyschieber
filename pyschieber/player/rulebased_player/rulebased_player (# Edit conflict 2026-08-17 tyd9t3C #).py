...
from pyschieber.player.rulebased_player.strategy.jass_strategy import JassStrategy
...
class RuleBasedPlayer(BasePlayer):
    ...
    def choose_trumpf(self, geschoben: bool) -> Generator[str | None, None, None]:
        ...
        while not allowed:
            ...
            allowed = yield trumpf  # type: ignore
            if allowed:
                yield None
    ...
    def move_made(self, player_id: int, card: Card, state: StatusDict) -> None:  # pyright: ignore[reportIncompatibleMethodOverride]
