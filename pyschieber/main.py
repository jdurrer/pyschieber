...
def start_tournament(points: float) -> None:
    ...
    tournament.play(
        use_counting_factor=counting_factor_bool,
        allow_weis=weisen_bool,
        rounds=Spielrunden,
        benchmark_enabled=benchmark_bool,
    )
...
def get_players() -> list:
    ...
    players2 = [
        GreedyPlayer(name="GreedyA"),
        TreePlayer(name="TreeA"),
        GreedyPlayer(name="GreedyB"),
        TreePlayer(name="TreeB"),
    ]

    """Performance test against strong opponent"""
    # # Team 1 = Challenge, Team 2 = Tree
    players3 = [
        ChallengePlayer(name="ChallengeA"),
        TreePlayer(name="TreeA"),
        ChallengePlayer(name="ChallengeB"),
        TreePlayer(name="TreeB"),
    ]
    ...
    players5 = [
        ChallengePlayer(name="AAA"),
        ChallengePlayer(name="BBB"),
        ChallengePlayer(name="CCC"),
        ChallengePlayer(name="DDD"),
    ]

    """Plausability Test"""
    players6 = [
        ChallengePlayer(name="AAA"),
        GreedyPlayer(name="BBB"),
        ChallengePlayer(name="CCC"),
        GreedyPlayer(name="DDD"),
    ]

    players7 = [
        ChallengePlayer(name="ChallengeA"),
        RuleBasedPlayer(name="RuleA"),
        ChallengePlayer(name="ChallengeB"),
        RuleBasedPlayer(name="RuleB"),
    ]

    players8 = [
        TreePlayer(name="TreeA"),
        RuleBasedPlayer(name="ChallengeA"),
        TreePlayer(name="TreeB"),
        RuleBasedPlayer(name="ChallengeB"),
    ]
